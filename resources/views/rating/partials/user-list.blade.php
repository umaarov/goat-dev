        ...
        @forelse($users as $index => $user)
            <li>
                <a href="{{ route('profile.show', ['username' => $user->username]) }}"
                   class="p-4 flex items-center space-x-4 transition-colors hover:bg-gray-50/75 dark:hover:bg-gray-700/50">
                    <div class="flex items-center justify-center w-8 text-center">
                        ...
                        @else
                            <span class="font-semibold text-gray-500 dark:text-gray-400 text-sm">{{ $index + 1 }}</span>
                        @endif
                    </div>
                    ...
                    <div class="text-right flex-shrink-0">
                        ...
                        @endphp
                        <p class="text-md font-bold text-gray-900 dark:text-gray-50">{{ number_format($value) }}</p>
