        ...
        <div class="p-6 relative ">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('auth.x') }}"
                   class="w-full flex items-center justify-center bg-black text-white py-2.5 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-colors">
                    ...
                    <span class="font-medium text-sm">{{ __('messages.auth.signup_with_x') }}</span>
                </a>
                <a href="{{ route('auth.telegram.redirect') }}"
                   class="w-full flex items-center justify-center bg-[#2AABEE] text-white py-2.5 rounded-lg hover:bg-[#1E98D4] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                    ...
                    <span class="font-medium text-sm">{{ __('messages.auth.signup_with_telegram') }}</span>
                </a>
            </div>
            ...
            <div class="mt-3">
                <button type="button" id="github-auth-btn"
                    ...
                    <span class="font-medium text-sm">{{ __('messages.auth.signup_with_github') }}</span>
                </button>
            </div>
