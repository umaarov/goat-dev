        ...
        @else
            <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    >{{ old('question', $post->question) }}</textarea>
                    @error('question')
                    ...
                    <fieldset class="border border-gray-300 p-4 rounded-md">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="option_one_title" type="text" name="option_one_title"
                                   class="w-full px-3 py-2 border @error('option_one_title') border-red-500 @else border-gray-300 @enderror rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   value="{{ old('option_one_title', $post->option_one_title) }}">
                        ...
                        <div class="mb-3">
                            ...
                            @if($post->option_one_image)
                                <div class="mb-2">
                                    ...
                                    <img src="{{ asset('storage/' . $post->option_one_image) }}"
                                         alt="Current Option 1 Image" class="max-h-24 rounded border border-gray-200 zoomable-image">
                                    <label class="mt-1 flex items-center text-xs text-gray-600">
                                        <input type="checkbox" id="remove_option_one_image_checkbox" name="remove_option_one_image" value="1"
                            ...
                            <label for="option_one_image_trigger_edit" class="inline-block mb-1 text-sm font-medium text-blue-600 hover:text-blue-800 cursor-pointer underline">
                                {{ $post->option_one_image ? 'Replace image' : 'Upload image' }}
                            </label>
                            <div id="option_one_new_image_preview_container_edit" class="w-32 h-32 bg-gray-100 rounded-md flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-blue-500 mb-2 mt-1 {{ $errors->has('option_one_image') ? '' : 'hidden' }}">
                                <div id="option_one_new_image_placeholder_edit" class="text-center text-gray-500 p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4v16m8-8H4"/></svg>
                                    <p class="mt-1 text-xs">New Image</p>
                                </div>
                                <img id="option_one_new_image_preview_edit" class="h-full w-full object-cover object-center hidden rounded-md" src="#" alt="New Option 1 Preview">
                            </div>
                    ...
                    <fieldset class="border border-gray-300 p-4 rounded-md">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="option_two_title" type="text" name="option_two_title"
                                   class="w-full px-3 py-2 border @error('option_two_title') border-red-500 @else border-gray-300 @enderror rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                   value="{{ old('option_two_title', $post->option_two_title) }}">
                        ...
                        <div class="mb-3">
                            ...
                            @if($post->option_two_image)
                                <div class="mb-2">
                                    ...
                                    <img src="{{ asset('storage/' . $post->option_two_image) }}"
                                         alt="Current Option 2 Image" class="max-h-24 rounded border border-gray-200 zoomable-image">
                                    <label class="mt-1 flex items-center text-xs text-gray-600">
                                        <input type="checkbox" id="remove_option_two_image_checkbox" name="remove_option_two_image" value="1"
                                               class="mr-1 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                        Remove current image
                                    </label>
                                </div>
                            ...
                            <label for="option_two_image_trigger_edit" class="inline-block mb-1 text-sm font-medium text-blue-600 hover:text-blue-800 cursor-pointer underline">
                                {{ $post->option_two_image ? 'Replace image' : 'Upload image' }}
                            </label>
                            <div id="option_two_new_image_preview_container_edit" class="w-32 h-32 bg-gray-100 rounded-md flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-blue-500 mb-2 mt-1 {{ $errors->has('option_two_image') ? '' : 'hidden' }}">
                                <div id="option_two_new_image_placeholder_edit" class="text-center text-gray-500 p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4v16m8-8H4"/></svg>
                                    <p class="mt-1 text-xs">New Image</p>
                                </div>
                                <img id="option_two_new_image_preview_edit" class="h-full w-full object-cover object-center hidden rounded-md" src="#" alt="New Option 2 Preview">
                            </div>
