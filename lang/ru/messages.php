...
return [
    ...
    'app.meta_description_default' => 'GOAT — это ведущая площадка для структурированных и высококачественных дебатов. Создавайте и голосуйте в опросах "это или то". Присоединяйтесь к сообществу, делитесь своим мнением и смотрите, что в тренде.',
    ...
    'copyright' => [
        'title' => 'Авторское право (DMCA)',
        'meta_description' => 'Политика авторского права и процедуры DMCA на GOAT.uz.',
        'heading' => 'Авторское право и Интеллектуальная собственность',
        'intro_text' => 'GOAT.uz уважает права интеллектуальной собственности других лиц. В соответствии с Законом об авторском праве в цифровую эпоху (DMCA) и местным законодательством, мы оперативно реагируем на обоснованные жалобы о нарушении авторских прав.',
        'reporting_heading' => 'Сообщить о нарушении',
        'reporting_text' => 'Если вы считаете, что ваша работа была скопирована с нарушением авторских прав, пожалуйста, сообщите об этом нашему агенту по авторским правам: :email',
        'removal_heading' => 'Удаление контента',
        'removal_text' => 'Мы оставляем за собой право удалять контент, предположительно нарушающий авторские права, без предварительного уведомления и без какой-либо ответственности перед вами.',
    ],

    'terms' => [
        'disclaimer_heading' => 'Отказ от ответственности',
        'disclaimer_text' => 'Взгляды, мнения и обсуждения, выраженные на GOAT.uz, принадлежат исключительно их авторам и пользователям. Они не обязательно отражают официальную политику или позицию GOAT.uz. Мы не несем ответственности за ошибки, упущения или клеветнические заявления в пользовательском контенте.',
    ],
    ...
    'sessions_title' => 'Управление сессиями',
    'sessions_description' => 'Это список устройств, которые вошли в ваш аккаунт. Отмените доступ для любых сессий, которые вы не узнали.',
    ...
    'session_terminate_confirm' => 'Вы уверены, что хотите завершить эту сессию?',
    'session_terminated_successfully' => 'Сессия успешно завершена.',
    'no_other_sessions' => 'У вас нет других активных сессий.',
    ...
    'settings' => [
        ...
        'ai_insight_label' => 'Отображение AI Insight',
        'ai_insight_description' => 'Выберите, как отображается контекст, сгенерированный AI, в постах.',
        'ai_insight_expanded' => 'Всегда расширено',
        'ai_insight_expanded_desc' => 'Показывать полный контекст AI по умолчанию. Лучше всего подходит для тех, кто любит детали.',
        'ai_insight_less' => 'Показать меньше',
        'ai_insight_less_desc' => 'Показывать короткий предварительный просмотр по умолчанию с кнопкой "Показать больше".',
        'ai_insight_hidden' => 'Скрыто по умолчанию',
        'ai_insight_hidden_desc' => 'Скрыть панель полностью. Вы можете открыть ее, нажав на значок рядом с вопросом.',
    ],
    ...
    'auth' => [
        ...
        'github_developer_perks_title' => 'GitHub Разработчик Перки',
        'github_developer_perks_desc' => 'Свяжите свой аккаунт GitHub, чтобы получить эксклюзивные преимущества разработчика, такие как доступ к бета-функциям и API.',
        'login_with_github' => 'Войти с помощью GitHub',
        'signup_with_github' => 'Зарегистрироваться с помощью GitHub',
        'github_link_success' => 'Вы успешно связали свой аккаунт GitHub!',
    ...
    'create_post.template_title' => 'Быстрый старт',
    'create_post.template_description' => 'Используйте предопределенный шаблон "Да / Нет".',
    'create_post.apply_template_button' => 'Применить шаблон',
    'create_post.applying_template_button' => 'Применение шаблона...',

    'create_post.template_load_error' => 'Не удалось загрузить шаблон. Пожалуйста, попробуйте еще раз позже.',
