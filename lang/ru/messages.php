...
//    'home.page_title_posts' => 'Главная - Посты',
    ...
    'contribution' => [
        ...
        'ways_to_contribute_heading' => 'Способы участия',
        'ways_to_contribute_p1' => 'Существует множество способов внести свой вклад: от написания кода и документации до сообщения об ошибках и предложения новых функций.',

        'bugs_heading' => 'Сообщение об ошибках',
        'bugs_text' => 'Если вы обнаружили ошибку, сначала убедитесь, что она ещё не была зарегистрирована, выполнив поиск по открытым задачам на GitHub. Если похожая проблема не найдена, создайте новую задачу. Обязательно укажите чёткое название, подробное описание шагов для воспроизведения ошибки, а также приложите соответствующие логи или скриншоты через',
        'issue_tracker_link' => 'наш трекер задач',

        'enhancements_heading' => 'Предложения по улучшению',
        'enhancements_text' => 'Предложения по улучшению рассматриваются в виде задач на GitHub. Перед созданием новой задачи, пожалуйста, проверьте, не обсуждалась ли уже ваша идея. Укажите чёткое и подробное описание предлагаемой функции, её потенциальную ценность и обоснование необходимости её внедрения.',

        'pr_heading' => 'Отправка Pull Request',
        'pr_intro' => 'Мы открыты к принятию ваших pull request’ов. Чтобы процесс прошёл максимально гладко, следуйте этим шагам:',
        'pr_step_1' => 'Сделайте форк репозитория и создайте отдельную ветку от ветки master. Используйте описательное название ветки (например, feature/user-profiles или fix/login-bug).',
        'pr_step_2' => 'Настройте локальную среду и внесите необходимые изменения. Соблюдайте принятый стиль кодирования.',
        'pr_step_3' => 'Создайте pull request в ветку master. Укажите чёткое описание проблемы и предлагаемого решения. При необходимости добавьте номер связанной задачи (например, Closes #37).',

        'coc_heading' => 'Кодекс поведения',
        'coc_text' => 'Данный проект и все его участники следуют Кодексу поведения GOAT. Участвуя, вы обязуетесь соблюдать этот кодекс. Нарушения следует незамедлительно сообщать команде модерации проекта.',
        'coc_link_text' => 'Ознакомиться с Кодексом поведения',

        'thanks_text' => 'С нетерпением ждём вашего участия!',
    ],
